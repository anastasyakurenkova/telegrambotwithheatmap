...
```
cd existing_repo
git remote add origin https://git.miem.hse.ru/aakurenkova_5/kurenkovaanastoasiacomputergraphicks.git
git branch -M master
...
- [ ] [Set up project integrations](https://git.miem.hse.ru/aakurenkova_5/kurenkovaanastoasiacomputergraphicks/-/settings/integrations)
...
## Использование
Этот код может использоваться для того, чтобы создать бота, с описанными свойствами. 
